...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            FXMLLoader splashLoader = new FXMLLoader(getClass().getResource("/com/aegisvault/gui/fxml/splash.fxml"));
            ...
            // Maximize window to fit screen resolution
            ...
            splashSequence.setOnFinished(e -> {
                try {
                    FXMLLoader loginLoader = new FXMLLoader(getClass().getResource("/com/aegisvault/gui/fxml/login.fxml"));
